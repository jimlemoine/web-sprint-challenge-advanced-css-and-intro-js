...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    if (years[0] >= 1900 && years[0] < 2000 && years[2] >= 1900 && years[2] < 2000) {
      dead.push(array[i]['name']);
    }
  }
  return dead;
}
...
function addArtist(array) {
  array.push({id:20, name: 'Jim Lemoine', years: '1980 - 2021', genre: 'Web Design', nationality: 'USA', bio: 'Some info about Jim and stuff'});
  return array;
}
